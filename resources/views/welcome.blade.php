      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Tot Laki</span>
              <span class="info-box-number">{{ $laki }}
                <small>orang</small>
              </span>
            </div>
            <!-- /.info-box-content -->
        ...
        <div class="col-12 col-sm-6 col-md-4">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Tot Perempuan</span>
              <span class="info-box-number">{{ $perempuan }}
                <small>orang</small>
              </span>
            </div>
            <!-- /.info-box-content -->
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h5 class="card-title">Report Data Karyawan</h5>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="chart">
                    ...
                    {{-- <canvas id="container" height="180" style="height: 180px;"></canvas> --}}
                  </div>
                  <!-- /.chart-responsive -->
                </div>
                <!-- /.col -->
...
<script>
  Highcharts.chart('container', {
    ...
    series: [{
        name: 'Karyawan',
        data: [{{ $laki }},{{ $jumlahkaryawan }},{{ $perempuan }}]
